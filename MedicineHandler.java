...
//        System.out.println(medicine);
    ...
    @ResponseBody
    @GetMapping("/deleteMedById")
    public Integer deleteMedById(String medicineId){
        Integer index = medicineService.deleteMedById(medicineId);
        medMService.deleteByMedId(medicineId);
        return index;
    }
